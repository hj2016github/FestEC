...
public class RestClientBuilder {
  ...
  //  private LoaderStyle mLoaderStyle = null;
    ...
    public final RestClientBuilder params(WeakHashMap<String, Object> params) {//直接输入map
        PARAMS.putAll(params);
        return this;
    }

    public final RestClientBuilder params(String key, Object value) {//输入键值对;
    ...
    public final RestClientBuilder raw(String raw) {//传入原始字符串json;
